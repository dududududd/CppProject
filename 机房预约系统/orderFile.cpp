...
OrderFile::OrderFile()
{
		...
		>> stuId && ifs >> stuName && ifs >> roomId && ifs >> status)
	{
		...
		if (pos != -1)
		{
			...
			value = date.substr(pos + 1, date.size() - pos - 1);//size = 10 pos = 4   size - pos = 6 - 1 
		...
		if (pos != -1)
		{
			...
			value = interval.substr(pos + 1, interval.size() - pos - 1);//size = 10 pos = 4   size - pos = 6 - 1 
			m.insert(make_pair(key, value));
		}
		...
		if (pos != -1)
		{
			...
			value = stuId.substr(pos + 1, stuId.size() - pos - 1);//size = 10 pos = 4   size - pos = 6 - 1 
			m.insert(make_pair(key, value));
		}
		...
		if (pos != -1)
		{
			...
			value = stuName.substr(pos + 1, stuName.size() - pos - 1);//size = 10 pos = 4   size - pos = 6 - 1 
			m.insert(make_pair(key, value));
		}
		...
		if (pos != -1)
		{
			...
			value = roomId.substr(pos + 1, roomId.size() - pos - 1);//size = 10 pos = 4   size - pos = 6 - 1 
			m.insert(make_pair(key, value));
		}
		...
		if (pos != -1)
		{
			...
			value = status.substr(pos + 1, status.size() - pos - 1);//size = 10 pos = 4   size - pos = 6 - 1 
			m.insert(make_pair(key, value));
		}
